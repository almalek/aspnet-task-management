...
namespace Codex.Controllers
{
    public class TasksController : Controller
    {
        ...
        public TasksController(CodexContext context)
        {
            _context = context;
        }
        ...
        {
            var codexContext = _context.Tasks.Include(t => t.Employee);
        ...
        {
            ViewData["EmployeeForeignKey"] = new SelectList(_context.Employees, "EmployeeId", "Name");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaskId,Title,Type,Details,Status,Priority,DueDate,EmployeeForeignKey")] Models.Task task)
        {
            if (id != task.TaskId)
            {
                return NotFound();
